...
void InitStates()
{
    ...
    rd.FillMode = D3D11_FILL_SOLID;
    rd.CullMode = D3D11_CULL_BACK;
    // NOTE(Barret5Ocal): The vertices might be backwords. Be careful with how the vertices
    // are placed in the future
    rd.FrontCounterClockwise = TRUE;
    rd.DepthClipEnable = TRUE;    // turn off depth clipping
        ...
        int ShowCode)
{
    ...
    if(RegisterClass(&WindowClass))
    {
        ...
        if(Window)
        {
            ...
            int x,y,n;
            unsigned char *data = stbi_load("Wood.png", &x, &y, &n, 0);
            ...
            Dev->CreateTexture2D( &desc, NULL, &pTexture );
